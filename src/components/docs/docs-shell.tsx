...
import { buildDocsBreadcrumbItems } from "@/src/components/docs/docs-breadcrumbs"
      ...
      <div className="relative space-y-3 rounded-2xl border border-border/70 bg-linear-to-b from-background to-muted/20 p-5 shadow-sm sm:p-7">
        ...
        <div className="relative space-y-3">
          <PageHeader
            title={title}
            description={summary}
            breadcrumbItems={buildDocsBreadcrumbItems(currentPage)}
            breadcrumbCurrentLabel={currentPage ? currentPage.title : badgeLabel}
            className="max-w-4xl"
